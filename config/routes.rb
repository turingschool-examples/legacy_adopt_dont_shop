...
#Applications
get "/applications", to: "applications#index", as: :application
get "applications/new", to: "applications#new", as: :application_new
get "/applications/:id/edit", to: "applications#edit", as: :application_edit
get "/applications/:id", to: "applications#show", as: :application_show
